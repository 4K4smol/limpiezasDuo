...
class StoreOrdenTrabajoRequest extends FormRequest
{
    ...
    {
        return true; // Ya controlas acceso con middleware
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'detalles.*.horas_realizadas.numeric' => 'Las horas deben ser un número.',
            'detalles.*.horas_realizadas.min' => 'Mínimo 0.25 horas por servicio.',
        ];
    }
}
